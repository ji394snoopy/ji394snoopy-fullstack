$(document).ready(function() {
    ...
    var vResume = new Vue({
        ...
        data: {
            ...
            introduction: ["喜歡學習技術和充實自己，在求學期間除了本科之外的課程，也常常去選修資工系或企管系的課程。大三以 <具人文內涵的城市旅遊APP>參加許多比賽，大四暫時性接下維護Ios App的工作，也因此進入撰寫行動App的世界。", "現今是前端工程師，但目標成為全端工程師，在閒暇的時間也會學習新的語言充實自己。自行研究Node.js和Vue.js等後端技術和前端框架，以備未來有機會時可以用上。除了網頁，也因為工作更深入原生Android開發和Ios Swift3，皆有一些學習經驗。工作絕大部分皆為獨立開發，但希望能有合得來的夥伴能付相切磋進步。"],
            skills: [{
                name: "Html5/Css3",
                percentage: 85,
                isBase: true,
